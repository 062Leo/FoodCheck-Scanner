      ...
      if (existing.raw_json) {
        try {
          ...
          if (product.brands !== undefined) {
            parsed.brands = product.brands;
            modified = true;
          }
          if (product.category !== undefined) {
            parsed.categories = product.category;
            modified = true;
          }
          if (product.ingredients !== undefined) {
            parsed.ingredients_text = product.ingredients;
            modified = true;
          }
          ...
          if (product.nutriments) {
            ...
            if (n.energyKcal100g !== undefined)
              parsed.nutriments['energy-kcal_100g'] = n.energyKcal100g;
            if (n.fat100g !== undefined) parsed.nutriments.fat_100g = n.fat100g;
            if (n.saturatedFat100g !== undefined)
              parsed.nutriments['saturated-fat_100g'] = n.saturatedFat100g;
            if (n.carbohydrates100g !== undefined)
              parsed.nutriments.carbohydrates_100g = n.carbohydrates100g;
